...
def process_folder(folder, pca):
    ...
    for pdb_file in os.listdir(folder):
        if pdb_file.endswith('.pdb'):
            ...
            coords_ca, coords_all, atom_to_ca_map = extract_coords_from_pdb_by_seq(folder + pdb_file, TRA_aa_seq, TRB_aa_seq, antigen_epitope)
...
if __name__ == '__main__':
    ...
    for folder in os.listdir('/projects/structures/clusters/MHCI_align/'):
        if "_" not in folder:
            process_folder(f'/projects/structures/clusters/MHCI_align/{folder}/')
